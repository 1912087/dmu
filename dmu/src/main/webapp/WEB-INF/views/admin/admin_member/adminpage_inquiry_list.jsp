...
<link rel="stylesheet" href = "http://localhost:9000/css/adminpage_inquiry.css">
<script src = "http://localhost:9000/js/jquery-3.6.0.min.js"></script>
<script src="//t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script>
<script src = "http://localhost:9000/js/admin_inquiry.js"></script>
								...
								<li class="on">
									...
									<div class="sub-menu-list">
										<ul>
											...
											<li class="">
												<a class="" href="/adminpage_inquiry_list" style="color: black;font-size: 17.5px;font-weight: 700;">1대1 문의</a>
											</li>
										</ul>
									</div>
								</li>
									...
									<ul style="list-style:none;">
										<li>
											<div class = "admin-inquiry-author">
												<img src="http://localhost:9000/images/public.svg">
											...
											<button type = "button" class = "admin-inquiry-answer">
												<img src = "http://localhost:9000/images/airplane.png">
												<div>답변 보내기</div>
												<hr class = "back_hr1">
												<hr class = "back_hr2">
												<hr class = "back_hr3">
						...
						<div>
							...
							<div class = "popup_admin_inquiry_answer_content" style = "width: 100%;">
								...
								<div style = "display : none;">
									<img src = "http://localhost:9000/images/warning.png">
