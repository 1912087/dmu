...
<body>
	...
	<div class = "main">
							...
							<ul>
								...
								<li class="on">
									...
									<div class="sub-menu-list">
										<ul>
											<li class="">
												<a class="" href="/adminexhibition_list">전시회 리스트 작성</a>
											</li>
											<li class="">
												<a class="" href="/admin_notice_list">공지사항 작성</a>
											</li>
										</ul>
									</div>
								</li>
									...
									<div class="purchase-result-list-content" style = "width : 100%;">
										<div style="border-bottom: 0.5px solid #ddd;">
											<div class="purchase-result-content-title" style = "width : 100%;">
													<img src="http://localhost:9000/upload/${ list.ticketVo.dsfile }"
														style = "width : 250px;">
												<table>
													<tr>
	 ...
	 <iframe src="/footeo" width="100%" height="490px" scrolling="no" frameborder=0 class = "footer" style="margin-bottom:-5px" ></iframe>
				...
				<div class = "refund_content">
					<div class = "refund_ticket">
						<div class="refund_ticket_list">
							<form name = "refundForm" action = "/adminpage_ticket_cancel" method = "post">
								<table>
									<tr style = "background:#efefef;">
										<th>티켓번호</th>
										<th>관람일</th>
