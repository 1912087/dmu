...
$(document).ready(function() {
		...
		jQuery('#ampaginationsm').on(
				...
				function(e) {
					...
					$(location).attr(
							'href',
							"http://localhost:9000/adminpage_admin_list?rpage="
									+ e.page);
				});
			...
			<div class="container">
				<aside class="mypage">
					<div class="mypage-list">
						<a href="/adminpage_main" class="mypage-main"> <strong
							...
							<ul>
								<li class="on"><a class="menu-title" href="#">ADMIN</a>
									<div class="sub-menu-list">
										<ul>
											<li class=""><a class="" href="/adminpage_member_list">회원관리</a>
											</li>
											<c:if test="${sessionScope.member.mid == 'master'}">
												<li class=""><a class="" href="/adminpage_admin_list"
													style="color: black; font-weight: 700;">관리자승인</a></li>
											</c:if>
											<li class=""><a class=""
												href="/adminpage_reservation_list">예매관리</a></li>
											<li class=""><a class="" href="/adminpage_inquiry_list">1대1 문의</a></li>
										</ul>
									</div></li>
								<li class="on"><a class="menu-title">CONTENT</a>
									<div class="sub-menu-list">
										<ul>
											<li class=""><a class="" href="/adminexhibition_list"
												target="_blank">전시회 리스트 작성</a></li>
											<li class=""><a class="" href="/admin_notice_list"
	...
	<div class="background_ok">
		<div class="window_ok">
			<div class="popup_ok">
				...
				<!--  <form name="acceptForm" action="acceptUpdate" method="post">-->
