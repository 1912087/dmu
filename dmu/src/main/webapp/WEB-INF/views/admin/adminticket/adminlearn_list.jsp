...
$(document).ready(function(){
    ...
    function ajax_target_list(dtarget, rpage){
       $.ajax({
            url : 'learn_ajaxlist?dtarget='+dtarget+"&rpage="+rpage, // 이주소로 보낼건데 
            ...
            success : function(data){
               ...
               $(".total strong").text(dataset.dbCount);
                  ...
                  output +="<a data-v-41f56098='' href='/adminticketlist_content/"+aj.did+"'  class='thumb'>"
                  ...
                  output +="</ul>"
                  output +="<a data-v-41f56098='' href='/adminticketlist_content/"+aj.did+"' class='title'>" +aj.dtitle +"</a>"
    ...
    function ajax_orderby_list(day, dtarget, rpage){
       $.ajax({
              url : 'orderby_ajaxlist?day='+day+"&dtarget="+dtarget+"&rpage="+rpage, 
              type : "get" ,
              cache : false,
              headers : {"cache-control" : "no-cache" , "pragma" : "no-cache"},
              success : function(data){
                                    ...
                                    <div data-v-41f56098="" class="list-top-area"
                                       ...
                                       <ul data-v-41f56098="" class="order">
                                          <li data-v-3c1f59cb="" class="">
                                             <a data-v-3c1f59cb="" href="/adminticketlist_write">
