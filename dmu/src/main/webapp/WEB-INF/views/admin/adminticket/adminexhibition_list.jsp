...
$(document).ready(function(){
	$('.orderby').click(function(){
		...
		ajax_orderby_list(0,1);
			...
			$.ajax({
				url : 'orderby_exhibition_ajaxlist?day='+day+"&rpage="+rpage, 
				type : "get" ,
				cache : false,
				...
				success : function(data){
					let dataset = JSON.parse(data);
						...
						for(aj of dataset.list){
							...
							output +=	"<a data-v-3c1f59cb='' href='http://localhost:9000/dmu/adminticketlist_content?did="+aj.did+"' target='_parent' class='thumb'>"
							...
							output +=	"<a data-v-3c1f59cb='' href='http://localhost:9000/dmu/adminticketlist_content?did="+aj.did+"' target='_parent' class='title'>"+aj.dtitle+"</a>"  
		...
		$('#more_button').click(function(){
			...
			$(location).attr('href', "http://localhost:9000/dmu/adminexhibition_list?rpage="+${rpage+1});
			});
			 var rpage = "${rpage}";
			if(rpage != 1){
