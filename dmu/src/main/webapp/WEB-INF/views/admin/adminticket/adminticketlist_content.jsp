...
<link rel="stylesheet" href="http://localhost:9000/css/jquery-ui.css">
...
<script src = "http://localhost:9000/js/jquery-ui.js"></script>
											...
											<div data-v-8ed31374="" class="left">
												<div data-v-8ed31374="" class="img-ticket">
													<c:if test="${vo.dsfile != null }">
														<img data-v-2fed1a9a="" data-v-1e8092ec="" src="http://localhost:9000/upload/${vo.dsfile }"> 
													</c:if>
												</div>
												...
												<div data-v-8ed31374="" class="use-info-ticket">
													<div data-v-26e42198="" data-v-8ed31374="" class="btn-area">
														<a href="/adminticket_update/${vo.did}"><button data-v-26e42198=""  type="button"  class="secondary small">수정</button></a>
														<a href="/adminticket_delete/${vo.did}"><button data-v-26e42198=""  type="button" class="secondary small">삭제</button></a>
