...
<link
	...
	rel="stylesheet">
<link rel="stylesheet"
	href="http://localhost:9000/css/ticketwrite.css">
				...
				<div data-v-25f87e60="" data-v-ec5a0c2c="">
					<div data-v-25f87e60="" class="sub-contents-area">
						...
						<form name="exhibitionlistform"
							action="/adminticketlist_write_check" method="post"
						...
						<!--------------- learn ----------------------->
						<!---------------------------------------------->
						<form name="learnlistform" action="/adminticketlist_write_check"
						...
						<form name="eventlistform" action="/adminticketlist_write_check"
							method="post" enctype="multipart/form-data">
							<input type="hidden" name="dcode" class="dcode123" value="">
