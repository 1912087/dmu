				...
				<div data-v-080a389a="" class="snb-area">
					<ul data-v-080a389a="" class="snb">
						<li data-v-080a389a="" class="on"><a data-v-080a389a=""
							href="/exhibition_past_page" role="button" style="cursor: pointer;">전체</a></li>
						<li data-v-080a389a="" class=""><a data-v-080a389a=""
							href="/exhibition_past_page1"role="button" style="cursor: pointer;">대림미술관 &amp; 디뮤지엄</a></li>
						<li data-v-080a389a="" class=""><a data-v-080a389a=""
							href="/exhibition_past_page2"role="button" style="cursor: pointer;">구슬모아당구장</a></li>
					</ul>
				</div>
