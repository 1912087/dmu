...
<link rel="stylesheet"
	href="http://localhost:9000/css/main_css.css">
<link rel="stylesheet"
	href="http://localhost:9000/css/index.css">
			...
			<header class="">
				<div class="header-web">
					<div class="header-side">
                        ...
                        <ul>
                            <li>
                                <a href="/login" class="" target="_parent"> LOGIN </a>
                            </li>
                            <li>
                                <a href="/join_status" class="" target="_parent"> BECOME A MEMBER </a>
                            </li>
                            <!---->
                            <!---->
                            <li>
                                <a href="/notice_list" class="" target="_parent"> NOTICE </a>
                            </li>
                            <li>
                        ...
                        <ul>
                            <li>
                                <a href="/logout" class="" target="_parent"> LOGOUT </a>
                            </li>
                            <c:choose>
					...
					<div class="main-menu-area">
						<h1>
							<a href="/index" target="_top">대림문화재단</a>
						</h1>
						<div class="main-menu">
							<ul>
								<li class="visit"><a href="visit_main" target="_parent"> VISIT </a></li> 
								<li class="exhibition"><a href="/exhibition_page" target="_parent"> EXHIBITION</a></li>
								<li class="learn"><a href="/learn_page/유아" target="_parent"> LEARN </a></li>
								<li class="event"><a href="/event_page" target="_parent"> EVENT </a></li>
								<li class="ticket"><a href="/exhibition_list" target="_parent"> TICKET </a></li>
							</ul>
							<div class="sub-menu" id="menu_visit" style="width: 100%;">
								<div class="pannel">
									<div>
										<div class="menu-area">
                                            <ul>
												<li><a href="/visit_main" style="" target="_parent"> 미술관 소개 </a></li>
												<li><a href="/visit_info" style="" target="_parent"> 관람안내 </a></li>
												<li><a href="/visit_map1" style="" target="_parent"> 오시는 길 </a></li>
                                            </ul>
										</div>
						...
						<div class="sub-menu normal" id="menu_exhibition" style="width: 100%;">
							<div class="pannel">
								<div>
									<div class="menu-area">
										<ul>
											<li><a href="/exhibition_page" style=""target="_parent"> 현재 전시 </a></li>
											<li><a href="/exhibition_past_page"style=""target="_parent"> 지난 전시 </a></li>
										</ul>
									</div>
								</div>
							</div>
						...
						<div class="sub-menu normal" id="menu_learn" style="width: 100%;">
							<div class="pannel">
								<div>
									<div class="menu-area">
										<ul>
											<li><a  style="" href="/learn_page/유아" target="_parent"> 유아 </a></li>
											<li><a  href="/learn_page/어린이" target="_parent"> 어린이 </a></li>
											<li><a  href="/learn_page/청소년" target="_parent"> 청소년 </a></li>
											<li><a  href="/learn_page/대학생" target="_parent"> 대학생 </a></li>
											<li><a  href="/learn_page/성인" target="_parent"> 성인 </a></li>
											<li><a  href="/learn_page/교사" target="_parent"> 교사 </a></li>
											<li><a  href="/learn_page/전시해설" target="_parent"> 전시해설 </a></li>
										</ul>
									</div>
								</div>
							</div>
